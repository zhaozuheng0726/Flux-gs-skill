...
CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=garden python train.py -s ./datasets/mipnerf360/garden -i images --eval --densification_interval 500  --optimizer_type default --test_iterations 30000 --highfeature_lr 0.02 --loss_thresh 0.06  --grad_abs_thresh 0.0008    --num_mc_points  1024
...
CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=kitchen python train.py -s ./datasets/mipnerf360/kitchen -i images --eval --densification_interval 500  --optimizer_type default --test_iterations 30000  --highfeature_lr 0.02 --grad_abs_thresh 0.0006    --num_mc_points  1024
CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=bonsai python train.py -s ./datasets/mipnerf360/bonsai -i images --eval --densification_interval 500  --optimizer_type default --test_iterations 30000  --highfeature_lr 0.02 --grad_abs_thresh 0.0006  --num_mc_points  1024
CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=truck python train.py -s ./datasets/tandt/truck --eval --densification_interval 500  --optimizer_type default --test_iterations 30000  --highfeature_lr 0.04 --grad_abs_thresh 0.0009 --mult 0.7 
CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=train python train.py -s ./datasets/tandt/train --eval --densification_interval 500  --optimizer_type default --test_iterations 30000  --highfeature_lr 0.042 --grad_abs_thresh 0.0015 --dense 0.01 --mult 0.7 
...
CUDA_VISIBLE_DEVICES=0 python render.py -m output/flowers --skip_train   --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/garden --skip_train    --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/stump --skip_train      --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/treehill --skip_train   --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/room --skip_train       --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/counter --skip_train     --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/kitchen --skip_train     --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/bonsai --skip_train       --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/truck --skip_train --mult 0.7     --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/train --skip_train --mult 0.7      --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/playroom --skip_train --mult 0.7     --decode
CUDA_VISIBLE_DEVICES=0 python render.py -m output/drjohnson --skip_train --mult 0.7     --decode
